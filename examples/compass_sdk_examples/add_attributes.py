...
def main():
    ...
    try:
        ...
        print("\nNote: The attributes are now part of the document's content field")
        print("and can be used for filtering in search queries.")

        # Show example of how to filter with these attributes
        print("\nExample search filter using these attributes:")
        for key in attributes_dict.keys():
            print(
                f'  SearchFilter(type=SearchFilter.FilterType.EQ, field="content.{key}", value="{attributes_dict[key]}")'
            )
