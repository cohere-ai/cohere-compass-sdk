...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="""
        Perform a direct search using Elasticsearch-style queries with async client.
        Examples:
          Match all: '{"match_all": {}}'
...
async def main():
    ...
    try:
        ...
        response = await client.direct_search(
        ...
        if response.scroll_id:
            ...
            print(
                "Use async scroll functionality to retrieve all results with scrolling."
            )
