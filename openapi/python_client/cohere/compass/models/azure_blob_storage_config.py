...
class AzureBlobStorageConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "connection_string", "container_name", "name_starts_with"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['msft_azure_blob_storage']):
            raise ValueError("must be one of enum values ('msft_azure_blob_storage')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if name_starts_with (nullable) is None
        # and model_fields_set contains the field
        if self.name_starts_with is None and "name_starts_with" in self.model_fields_set:
            _dict['name_starts_with'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name_starts_with": obj.get("name_starts_with")
        })
        return _obj
