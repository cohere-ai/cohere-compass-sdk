...
class DataSource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "config", "destinations", "enabled", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": DatasourceConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
