...
class PaginatedListDataSource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["value", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DataSource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
